...
<body style="background-color: #C9BE62">
	<div class="modal-dialog modal-register">
		<div class="modal-content">
			<h4 class="modal-title">Account Opening Form</h4>
				...
				<form:form class="myclass" method="POST"
					...
					<div class="md-form">
						<i class="fa fa-mobile prefix white-text"></i> <label
							for="orangeForm-mobile">Aadhar Number</label>
						<form:input type="mobile" id="orangeForm-mobile2"
							class="form-control" path="aadharNo" required="true" minlength="16"
							maxlength="10" />
					</div>
					<div class="md-form">
						<i class="fa fa-mobile prefix white-text"></i> <label
							for="orangeForm-mobile">Pan Number</label>
						<form:input type="mobile" id="orangeForm-mobile2"
							class="form-control" path="panNo" required="true" minlength="10"
							maxlength="10" />
					</div>
					<div class="md-form">
